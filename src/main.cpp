//
// Created by Taerim Yoon on 16.07.24.
//
...
// #include <mocap_unitree_commons/MocapBaseStateEstimatorNode.h>
// #include <parkour_unitree_commons/ParkourControllerNode.h>
// #include <parkour_unitree_commons/ParkourObstacleNode.h>
// #include <parkour_unitree_commons/ParkourRobotData.h>
...
int main(int argc, char **argv) {
  ...
  //   }
  //   const auto data =
  //       std::make_shared<parkour::unitree::commons::ParkourRobotData>(robot);

  //   // machines
  //   auto m1 =
  //       crl::fsm::make_non_persistent_ps<Machines::ONBOARD,
  //       States::ESTOP>([&]() {
  //         return std::make_shared<crl::unitree::commons::EstopNode>(model,
  //         data);
  //       });
  //   auto m2 =
  //       crl::fsm::make_non_persistent_ps<Machines::ONBOARD,
  ...
  //             crl::unitree::commons::StarterNode::TargetMode::SQUAT, model,
  //             data, "squat");
  //       });
  //   auto m3 =
  //       crl::fsm::make_non_persistent_ps<Machines::ONBOARD,
  //       States::STAND>([&]() {
  //         return std::make_shared<crl::unitree::commons::StarterNode>(
  //             crl::unitree::commons::StarterNode::TargetMode::STAND, model,
  //             data, "stand");
  //       });
  // //   auto m4 = crl::fsm::make_non_persistent_ps<Machines::ONBOARD,
  // //                                              States::WALK>([&]() {
  // //     return
  // std::make_shared<parkour::unitree::commons::ParkourControllerNode>(
  // //         model, data);
  // //   });

  //   auto s_cols =
  //       crl::fsm::make_states_collection_for_machine<Machines::ONBOARD,
  //       States>(
  //           m1, m2, m3, /* m4 */);
  ...
  //       std::make_shared<mocap::unitree::commons::MocapBaseStateEstimatorNode>(
  //           model, data);
