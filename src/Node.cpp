...
Node::Node(
    ...
    const std::string &nodeName, bool useSimulator)
  ...
  controller_->setup(
      modelPath, this->get_parameter("default_pose").as_double_array(),
      this->get_parameter("action_scale").as_double(), useSimulator);
}
} // namespace crl::unitree_go1_interface